...
describe('backup: girone (v13)', () => {
  ...
  it('esporta e reimporta giocatori avversari, partite del girone e i campi nuovi', async () => {
    ...
    await db.competitions.add({ id: 5, nome: 'Precampionato', tipo: 'campionato', penalita: [{ squadraId: 0, punti: 1, motivo: 'Distinta' }] })
    ...
    expect(payload.dbVersion).toBe(13)
  ...
  it('carica un backup v13 scritto a mano, così com\'è', async () => {
    const payload = {
      ...
      tables: {
        ...
        competitions: [{ id: 1, nome: 'Precampionato', tipo: 'campionato' }],
        giocatoriAvversari: [
